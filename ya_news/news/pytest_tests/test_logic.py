...
def test_author_can_edit_comment(
    author_client, url_edit_comment, url_news_detail, form_data, comment
):
    ...
    assert comment_new.created == comment.created


def test_user_cant_edit_comment_of_another_user(
    reader_client, url_edit_comment, form_data, comment
):
